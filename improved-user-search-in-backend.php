...
Version: 1.1
Description:  This Plugin improves the search for users in WordPress backend significantly. It empowers admins to search for the first name, last name, email of users (and more) instead of only their nicknames/nicenames.
